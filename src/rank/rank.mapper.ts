...
export const intToRank = (rankInt: number | undefined | null): Rank => {
  if (rankInt === undefined || rankInt === null) return Rank.Stone1;
  if (rankInt === 0) return Rank.Locked;
  return (rankInt + 1) as Rank;
};
